...
person = Person("https://www.linkedin.com/in/hxs19", driver=driver)
```
...
person = Person("https://www.linkedin.com/in/hxs19/")
```
...
from selenium import webdriver
driver = webdriver.Chrome()
person = Person("https://www.linkedin.com/in/hxs19/", driver = driver, scrape=False)
```
4. Login to Linkedin
